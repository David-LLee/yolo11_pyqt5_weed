...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.centralwidget.setStyleSheet("#centralwidget{border-radius:20px;}")
        ...
        self.groupBox_18.setStyleSheet("#groupBox_18{border-image: url(:/img/icon/weed-back2.jpeg);\n"
"border-radius:20px;}")
...
"border-top-left-radius: 20px;}")
        ...
        self.label_7.setStyleSheet("image: url(:/img/icon/weed.png);")
...
"")
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.label_4.setText(_translate("mainWindow", "YOLOv11-pyQt杂草监测与定位系统"))
